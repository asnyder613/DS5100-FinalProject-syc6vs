...
If you would like to see the results of your roll, call the showResult method. The return value will be a dataframe containing the faces rolled during the game. You may pass either 'wide' or 'narrow' as an argument to determine the format of the returned dataframe.
